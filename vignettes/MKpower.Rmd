...
power.ancova(n = 45, mu=c(7.5366, 11.9849, 13.9785), var = 29.0898)
power.ancova(mu=c(7.5366, 11.9849, 13.9785), var = 29.0898, power = 0.9)
power.ancova(n = 57, mu=c(7.5366, 11.9849, 13.9785), var = 29.0898)
```
...
We can also calculate the sample size for an imbalanced design.
```{r}
power.ancova(mu=c(7.5366, 11.9849, 13.9785), var = 29.0898, power = 0.8, 
...
We get a smaller total sample size with an imbalanced design.
